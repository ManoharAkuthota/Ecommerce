 ...
 * Module: components/home/MobileCard.jsx
 *
 * Glassmorphic smartphone product card for the public homepage showcase:
 ...
 * - "View Details" CTA button linking to /mobiles
 * - Shimmer skeleton state (MobileCardSkeleton)
 */
...
export const MobileCard = ({ mobile }) => {
  ...
  return (
    ...
    >
      {/* Ambient Inner Gradient on Hover */}
  ...
  return (
    <div className="flex flex-col justify-between rounded-3xl bg-dark-900/40 border border-dark-800/60 p-5 space-y-4 animate-pulse">
      ...
      <div className="pt-4 border-t border-dark-850 flex items-center justify-between">
        <div className="w-20 h-7 bg-dark-800 rounded" />
